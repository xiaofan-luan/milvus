...
// FenceGrowingSourceAdmission provides a mock function with given fields: channel
func (_m *MockBufferManager) FenceGrowingSourceAdmission(channel string) {
	_m.Called(channel)
}

// MockBufferManager_FenceGrowingSourceAdmission_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'FenceGrowingSourceAdmission'
type MockBufferManager_FenceGrowingSourceAdmission_Call struct {
	*mock.Call
}

// FenceGrowingSourceAdmission is a helper method to define mock.On call
//   - channel string
func (_e *MockBufferManager_Expecter) FenceGrowingSourceAdmission(channel interface{}) *MockBufferManager_FenceGrowingSourceAdmission_Call {
	return &MockBufferManager_FenceGrowingSourceAdmission_Call{Call: _e.mock.On("FenceGrowingSourceAdmission", channel)}
}

func (_c *MockBufferManager_FenceGrowingSourceAdmission_Call) Run(run func(channel string)) *MockBufferManager_FenceGrowingSourceAdmission_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *MockBufferManager_FenceGrowingSourceAdmission_Call) Return() *MockBufferManager_FenceGrowingSourceAdmission_Call {
	_c.Call.Return()
	return _c
}

func (_c *MockBufferManager_FenceGrowingSourceAdmission_Call) RunAndReturn(run func(string)) *MockBufferManager_FenceGrowingSourceAdmission_Call {
	_c.Run(run)
	return _c
}
...
// GetGrowingFlushProgress provides a mock function with given fields: ctx, channel, segmentIDs
func (_m *MockBufferManager) GetGrowingFlushProgress(ctx context.Context, channel string, segmentIDs []int64) ([]GrowingFlushSegmentProgress, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, []int64) ([]GrowingFlushSegmentProgress, error)); ok {
		return rf(ctx, channel, segmentIDs)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, []int64) []GrowingFlushSegmentProgress); ok {
...
//   - channel string
//   - segmentIDs []int64
func (_e *MockBufferManager_Expecter) GetGrowingFlushProgress(ctx interface{}, channel interface{}, segmentIDs interface{}) *MockBufferManager_GetGrowingFlushProgress_Call {
	return &MockBufferManager_GetGrowingFlushProgress_Call{Call: _e.mock.On("GetGrowingFlushProgress", ctx, channel, segmentIDs)}
}

func (_c *MockBufferManager_GetGrowingFlushProgress_Call) Run(run func(ctx context.Context, channel string, segmentIDs []int64)) *MockBufferManager_GetGrowingFlushProgress_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockBufferManager_GetGrowingFlushProgress_Call) RunAndReturn(run func(context.Context, string, []int64) ([]GrowingFlushSegmentProgress, error)) *MockBufferManager_GetGrowingFlushProgress_Call {
	_c.Call.Return(run)
	return _c
}
...
// Register provides a mock function with given fields: ctx, channel, _a2, opts
func (_m *MockBufferManager) Register(ctx context.Context, channel string, _a2 metacache.MetaCache, opts ...WriteBufferOption) error {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	var _ca []interface{}
	_ca = append(_ca, ctx, channel, _a2)
	_ca = append(_ca, _va...)
	ret := _m.Called(_ca...)
...
func (_e *MockBufferManager_Expecter) Register(ctx interface{}, channel interface{}, _a2 interface{}, opts ...interface{}) *MockBufferManager_Register_Call {
	return &MockBufferManager_Register_Call{Call: _e.mock.On("Register",
		append([]interface{}{ctx, channel, _a2}, opts...)...)}
}

func (_c *MockBufferManager_Register_Call) Run(run func(ctx context.Context, channel string, _a2 metacache.MetaCache, opts ...WriteBufferOption)) *MockBufferManager_Register_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
// WaitGrowingFlushDrained provides a mock function with given fields: ctx, channel, segmentIDs
func (_m *MockBufferManager) WaitGrowingFlushDrained(ctx context.Context, channel string, segmentIDs []int64) error {
	ret := _m.Called(ctx, channel, segmentIDs)

	if len(ret) == 0 {
		panic("no return value specified for WaitGrowingFlushDrained")
	}
...
// MockBufferManager_WaitGrowingFlushDrained_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'WaitGrowingFlushDrained'
type MockBufferManager_WaitGrowingFlushDrained_Call struct {
	*mock.Call
}

// WaitGrowingFlushDrained is a helper method to define mock.On call
//   - ctx context.Context
//   - channel string
//   - segmentIDs []int64
func (_e *MockBufferManager_Expecter) WaitGrowingFlushDrained(ctx interface{}, channel interface{}, segmentIDs interface{}) *MockBufferManager_WaitGrowingFlushDrained_Call {
	return &MockBufferManager_WaitGrowingFlushDrained_Call{Call: _e.mock.On("WaitGrowingFlushDrained", ctx, channel, segmentIDs)}
}

func (_c *MockBufferManager_WaitGrowingFlushDrained_Call) Run(run func(ctx context.Context, channel string, segmentIDs []int64)) *MockBufferManager_WaitGrowingFlushDrained_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].([]int64))
	})
	return _c
...
func (_c *MockBufferManager_WaitGrowingFlushDrained_Call) Return(_a0 error) *MockBufferManager_WaitGrowingFlushDrained_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockBufferManager_WaitGrowingFlushDrained_Call) RunAndReturn(run func(context.Context, string, []int64) error) *MockBufferManager_WaitGrowingFlushDrained_Call {
	_c.Call.Return(run)
	return _c
}
